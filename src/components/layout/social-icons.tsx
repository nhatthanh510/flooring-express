/**
 * lucide-react v1 removed brand glyphs, so the two socials the business
 * actually uses are inlined here. Paths are the Simple Icons outlines (CC0),
 * drawn with `currentColor` so they inherit the footer's link colours.
 */
